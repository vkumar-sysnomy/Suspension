...
public class LocationService extends Service implements LocationListener {
    ...
    public LocationService(Context context, Activity activity) {
        ...
        onLocationChangedListener = (OnLocationChangedListener)activity;
        getLocation();
    }
...
//                        }
    ...
    public void showSettingsAlert(){
        DialogUtils.showDialog(mContext, "GPS is settings", "GPS is not enabled. Do you want to go to settings menu?", "Settings", "Cancel",
